...
banner= """
 ...
 _______  _______  _______  _______  __    _  __    _  _______  ______   
|       ||       ||       ||   _   ||  |  | ||  |  | ||       ||    _ |  
|    _  ||  _____||       ||  |_|  ||   |_| ||   |_| ||    ___||   | ||  
|   |_| || |_____ |       ||       ||       ||       ||   |___ |   |_||_ 
|    ___||_____  ||      _||       ||  _    ||  _    ||    ___||    __  |
|   |     _____| ||     |_ |   _   || | |   || | |   ||   |___ |   |  | |
|___|    |_______||_______||__| |__||_|  |__||_|  |__||_______||___|  |_|
                                                                         
                                                                         
 created by : VICTOR-FRANKEN                                                                        
...
def prepare_args():
    ...
    """
    parser = ArgumentParser(description="Python Based Fast Port Scanner", usage="%(prog)s 192.1.23.23", epilog=" Example -%(prog)s -s 20 -e 40000 -t 500 -V 192.1.23.23")
    ...
    parser.add_argument("-v","--version",action="version",version="%(prog)s 1.0",help="display version number")
...
def prepare_ports(start:int,end:int):
    """generator function for ports 
        ...
        arguments:
            ...
            yeild port will create a type of array in memory 
    """
